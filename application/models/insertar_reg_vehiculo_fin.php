<div class="panel panel-default">
  ...
  <form action="<?php echo base_url();?>administracion/insertarFin_Reg_Vehiculo" method="post" id='insertar_vehiculo'  enctype="multipart/form-data">
    ...
    <tr><td colspan='4'><div id="nuevos_datos">  </div> </td></tr>	
        ...
        <tr>
          <td>NUM. VEHICULO:</td>
          <td><input name="num_vehiculo" id="num_vehiculo" class="form-control" type="text" value="" onkeypress="return validar(event);"  required /></td>        
        ...
        <tr>
          ...
          <td><input name="fecha_vencimiento_soat" id="fecha_vencimiento_soat" type="date" value="" class="form-control" required /></td>
          <td>FECHA VENCIMIENTO MATRICULA: </td>
          <td><input name="fecha_vencimiento_matricula"  id="fecha_vencimiento_matricula" type="date" value="" class="form-control" required /></td>
        </tr>
        <tr>   
        ...
        <tr>
          <td>FOTO VEHICULO: </td>
          <td colspan='3'><input name="userfile" type="file" value="" size="50" class="form-control" /></td>
        </tr>
